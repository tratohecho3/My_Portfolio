...
export const PROJECTS: Project[] = [
    ...
    {title:'Bussiness Localizator', description:'It is an app to create a mock bussiness and find it in the google maps API', image:"./assets/maps.jpg",type_of_project:'Frontend Development',techologies:['html','css','javascript','angular','bootstrap'], view: 'https://platzisquare-410ad.firebaseapp.com/', code: 'https://github.com/tratohecho3/PlatziSquare'},
